---
type: guide
title: 'Gold Just Broke the Dollar: Now Watch What Happens to Iran and China'
id: gold-broke-the-dollar
...
Portfolio Rebalancing Targets:
  Dollar-denominated assets:  reduce by 20%
  Self-custody Bitcoin:       establish position
  Physical gold:              accumulate monthly
  Foreign equities:           increase allocation
  Jurisdiction research:      complete by month 12
```

The short version:

- **Reduce dollar concentration** in savings and reserves
- **Hold real assets** in self-custody
- **Follow capital flows**, not headlines
- **Watch for restructuring signals** in your country
- **Build sovereign wealth** at the personal and community level

The multipolar world is not coming. It is here. The Pentagon said so. Position accordingly.

---

*Based on analysis from Simon Dixon's Hard Talk Live. For live commentary and market updates, follow Simon Dixon on X.*

Having covered the full analysis, let's now document how this guide was produced.

## Agent Contributions

### Role

Writer in single mode (transform).

#### Example: Transform Process

Input: 2-hour live transcript covering gold, stablecoins, macro, and geopolitics. Output: guide using the gold-breaking-the-dollar hook to frame the Financial Industrial Complex, China, and Iran as the real story behind the headline. Stablecoin and technical sections condensed to support the geopolitical thesis.

### Assumptions

- The FIC/TIC/MIC framework is as described by the source
- Pentagon national defense strategy document and its contents as cited by the source
- Capital flow data (50x international vs US inflows, $39B vs $771M) as reported by the source
- Iran economic data (72% food inflation, 42% general inflation) from December 2025 as cited
- Controlled Demolition Thesis attributed to analyst Shahid Bolsan via the source
- Trade deals (Canada-China, UK-Beijing, EU-India, India-Canada 18-year deal, Germany $3B EV subsidy) as described by the source

### Unknowns

- Whether the Pentagon defense strategy document has been publicly released or is sourced from leaks
- Current status of Iran-US negotiations and whether strikes have occurred
- Whether the IRGC hardliner purge thesis proves correct within the predicted two-year window
- Current capital flow data (may have shifted since broadcast)
- Whether Germany's $3B EV subsidy has passed final approval

### What's Next

Track these unknowns over the next 12 months. If the predictions prove correct, the thesis strengthens.
