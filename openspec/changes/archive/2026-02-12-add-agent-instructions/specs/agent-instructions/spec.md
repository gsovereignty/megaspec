...
Defines the content requirements for `docflow/AGENTS.md` — the instruction file that AI coding assistants read to help SMEs write engagement-validated documentation. This file is the bridge between DocFlow's research-backed validation rules and the AI assistant that helps authors write.
