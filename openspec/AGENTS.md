...
**Rule: ALWAYS read `@/prd.md` before writing or modifying any code.** Do not begin implementation until you have identified the relevant requirement(s) and read their OpenSpec Prompts.

Every implementation task MUST reference a specific requirement ID from the PRD. Use the OpenSpec Prompt for that requirement as the implementation specification. Cite research foundations (RF-XX) in validation diagnostic messages.

See also: `@/openspec/project.md` for project conventions, tech stack, and domain context.
