...
## Purpose
Defines the `docflow/AGENTS.md` instruction file generated by `docflow init`: research-based writing guidance (RF-01 through RF-19), content-type rules, interview and transform mode instructions, agent mode guidance, Agent Contributions format, and role contracts for researcher, writer, and reviewer.
## Requirements
